...
export function TableModal({ editTarget, onClose }: TableModalProps): JSX.Element {
  const { activeCampaign, createTable, updateTable } = useCampaignStore()
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-dark-950/80 backdrop-blur-sm animate-fade-in" onClick={onClose}>
      <div 
        className="w-full max-w-2xl max-h-[90vh] bg-dark-900 border border-white/20 shadow-2xl flex flex-col animate-slide-up overflow-hidden"
